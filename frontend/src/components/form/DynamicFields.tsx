...
const DynamicFields = ({
  ...
  name: string;
  values: IncomeFieldsType[] | ExpenseFieldsType[] | AssetFieldsType[] | ScheduledDebtFieldsType[];
  initialValues: IncomeFieldsType | ExpenseFieldsType | AssetFieldsType | ScheduledDebtFieldsType;
